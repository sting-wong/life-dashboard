...
import { LayoutDashboard, ListTodo, CheckSquare, FileText, CalendarClock } from "lucide-react";
...
export default function App() {
  ...
  return (
    <html lang="zh-CN">
      ...
      <body>
        {/* Full-screen centered app container */}
        <div className="flex items-start justify-center min-h-screen md:p-6">
          <div className="flex w-full md:max-w-[1180px] bg-white md:rounded-[28px] md:shadow-[0_24px_80px_rgba(15,23,42,0.10)] overflow-hidden" style={{ height: "100dvh" }} id="app-shell">
            <div className="hidden md:block">
              <Sidebar />
            </div>
            <div className="flex-1 flex flex-col min-w-0">
              <TopBar unreadNotifs={unreadNotifs} unreadCount={unreadCount} />
              <main className="flex-1 overflow-auto bg-[#F8FAF9] pb-20 md:pb-0">
                <Outlet />
              </main>
            </div>
          </div>
